...
class Pedido extends CI_Controller {
	...
	public function BuscarPedido()
	{
		if($this->input->get('id')){
			...
			$sql = "SELECT c.id_contato, c.referencia_imovel, c.assunto, c.nome_contato, c.telefone, c.texto, c.email, DATE_FORMAT(c.data_contato, '%d-%m') as data_contato, DATE_FORMAT(c.data_contato, '%h:%i') as hora_contato, i.img_imovel FROM contato c INNER JOIN imovel i ON (i.referencia_imovel = c.referencia_imovel) WHERE c.fg_ativo = 1 and c.id_contato = $idContato";
